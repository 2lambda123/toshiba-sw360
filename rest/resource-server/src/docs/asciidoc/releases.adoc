...
[[resources-release-update-ECC-Information]]
==== Listing release update ECC Information

A `PATCH` request will update ECC Information of Release

===== Response structure

include::{snippets}/should_document_update_release_ecc_information/response-fields.adoc[]

===== Example request

include::{snippets}/should_document_update_release_ecc_information/curl-request.adoc[]

===== Example response

include::{snippets}/should_document_update_release_ecc_information/http-response.adoc[]

===== Links

include::{snippets}/should_document_update_release_ecc_information/links.adoc[]